...
public:
    ...
    const static inline vector_props float_vector_props[] = {
            ...
            vector_props(float_vector_3_id, test_vector_len_A),
            vector_props(float_vector_4_id, test_vector_len_A)
    };
...
//    }
    ...
    const static inline vector_props double_vector_props[] = {
            ...
            vector_props(double_vector_3_id, test_vector_len_A),
            vector_props(double_vector_4_id, test_vector_len_A)
    };
